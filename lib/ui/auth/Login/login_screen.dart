...
import 'package:evently_app/ui/auth/Login/login_view_model.dart';
...
class _LoginScreenState extends State<LoginScreen> implements LoginNavigator {
  ...
  void showLoading(String loadingMsg) {
    ...
    DialogUtils.showLoading(context: context, loadingMsg: loadingMsg);
  }
  ...
  void showMessage(String message) {
    ...
    DialogUtils.showMsg(
        context: context, content: message, postActionName: 'Ok');
  }
